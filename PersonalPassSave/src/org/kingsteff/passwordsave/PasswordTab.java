...
public class PasswordTab extends AbsoluteLayout implements ValueChangeListener {
	...
	private void buildMainLayout() {
		...
		// passtable
		passtable = new FilterTable();
		passtable.setCaption("Your current passwordlist");
		passtable.setImmediate(true);
		
		passtable.setFilterDecorator(new FilesFilterDecorator());
		passtable.setFilterGenerator(new FilesFilterGenerator());
		
		addComponent(passtable, "top:210.0px;left:20.0px;right:0px;bottom:0px;");
